...
function renderTasks(tasks) {
  ...
  tasks.map( e => task.innerHTML += `
  <li ${e.completed ? 'class="strike"' : ""}>
  <p>${e.detail}</p>
  <div>
...
function manageTasks(event) {
  ...
  event.target.dataset.function === "delete" ? removeTask(parent): event.target.dataset.function === "complete" ? completeTask(parent) : ""
